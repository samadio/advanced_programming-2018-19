...
int main() {
  std::vector<int> v0{1, 2, 4}; //(initialising the vector elementwise)
  std::vector<int> v1(4, 4);	//creates a vector of 4 elements all containing 4
  ...
  for (auto x : {7, 8, 9})
    v1.push_back(x);		//add at the end of a vector a new element containing x
